...
fitdir = 'gaussfit_H2CO/central_chans_masked/' 
imagefile = fitdir + "B5IRS1_H2COa_robust05_multi_3_cut_K_contcorrected"
maskfile = fitdir + "B5IRS1_H2COa_robust05_multi_3_cut_K_contcorrected_mask.fits"
fitfile =  imagefile + '_2G_fitparams_2.fits'
fitfilefiltered =  imagefile + '_2G_fitparams_2_filtered_aicres.fits'
...
cube = pyspeckit.Cube(imagefile+'_masked.fits')
cube.maskmap = fits.getdata(maskfile).astype(bool)
cube.load_model_fit(fitfile, npars=3, npeaks=2, fittype='gaussian')

#open interactive panel
cube.mapplot()
cube.plot_spectrum(xmax, ymax, plot_fit=True)
cube.mapplot.plane = fits.getdata(fitfilefiltered)[4] #cube.parcube[4, :, :] - 10.2
